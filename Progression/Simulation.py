'''
Marvyn Mbeugmo
Ce programme simule une progression de joueur dans un jeu vidéo.
Le joueur gagne de l'expérience (XP) en réussissant des actions, et monte de niveau lorsqu'il atteint un certain seuil d'XP.
'''
